...
\td{All chemicals used in this work are of reagent-grade purity and without further purification.}
...
squared glass plates (\cm{2.5}\x\cm{2.5}) from Sigma Aldrich, 
\gls{ito} plates (\cm{2.5}\x\cm{2.5}) from Sigma Aldrich, 
\gls{fto} plates (\cm{5}\x\cm{5}) from Sigma Aldrich and steel foil (10~cm~x~10~cm) provided by Sunplugged GmbH (\url{http://sunplugged.at/)}.
%}
%
...
%the \td{particle swarm optimisation} started 
...
\td{precursor (transition metal complex \gls{zrpro}	\gls{vs} post-transition metal 
complex aluminium isopropoxide \ch{Al(PrO)3}), solvent (\gls{buoh} \gls{vs} 2-ethoxyethanol \ch{EtOEtOH}), reaction temperature 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Calcination of Films}\label{sec:exp-calc}
...
%\td{Screening}
%244 - 93 aquatic - 103 testing - 191 buthanol - 206 preopt - 244 emma
...
%Composition of the \td{aquatic solution (I thought this did not work?)}, heating program, blade distance (distance between blade and substrate) and layer count were varied but no homogeneous layers resulted. 
%
...
using the Plackett-Burman\cite{Plackett1946} design implemented in the \td{\texttt{python3}}
library texttt{pyDOE} \td{(Version 0.3.8)}; 
with 
(1,5), (4,10), (400,500), (120,480), (0.1,5) and  (20,80) 
as nominal and extreme values for 
relative concentration of Zr $c_{zr}$, number of coating layers $\lambda$, calcination temperature $T_{cal}$[\oc{}], heating rate $v_{cal}$[\oc{}/\h{}], \gls{db} velocity $v_{C}$[\mm{}/\s{}] and \gls{db} temperature $T_{C}$[\oc{}], respectively.
...
%ooooh 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The stabilization agent was changed from \td{\gls{acoh} to \gls{ipo} 
shortly before the \gls{pso}
(but why?)} because of much better \td{solution stability. (how did you test this?? see section \ref{sec:res-mat})}
