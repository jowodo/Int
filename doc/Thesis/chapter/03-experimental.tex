...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Production of Precursor Solutions}
\label{sec:exp-sol}
...
the heat treatment between coating layers (\SI{200}{\celsius} \gls{vs} \SI{200}{\celsius} and then \SI{400}
...
For transmittance the light entered the sample from the side with the coating layer. 
