...
%, which is needed to measure the conductivity of the applied layer and \td{for \gls{sem} micrographs. (don't follow?)}
...
and the \gls{db} velocity (\mmps{10}, \mmps{12}, \mmps{14}, \mmps{16}, \mmps{18} or \mmps{20}), 
...
%\td{plachett-burman design of experiment with conc, layers, calcination temperature, heating rate, C velocity and C temperature as input variables.}
