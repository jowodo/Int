...
In 1958 the US American Vanguard I\cite{vanguard2004} and the soviet Sputnik III\cite{sputnik1959} were the first satellites with solar cells with efficiencies under 10 \% (\td{cite?}).
...
Firstly, \td{the energy of the photon must be the same as the difference between two electronic states, a lower populated and a higher empty orbital.}
