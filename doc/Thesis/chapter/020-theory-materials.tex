...
A window layer of intrinsic \ch{ZnO} is deposited after the \ch{CdS} layer, followed by a highly conductive aluminium doped layer. 
...
The ions which are accelerated to the surface originate mostly from a plasma.
...
%\todo{40W, t=700s, p=0.002 mbar, gas inlet= 6 sccm (Ar), no heating or cooling
%sccm = Standard cubic centimetres per minute}
The settings on the Leybold sputtering system were as follows: 40 W for 700 seconds at 0.002 mbar and a argon gas inlet of 6 sccm (standard cubic centimeters per minute). % with a pressure of 0.002 mbar. 
...
Reflectance and transmittance were measured at \ang{0} and \ang{20} incident angle, respectively, with a Bruker Vertex 70.
