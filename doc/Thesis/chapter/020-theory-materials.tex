...
The next section concerns the description of materials and scientific methods used during the experminental part of this work. 
...
% what is used? 
Nobel gases (e.g. argon) in plasma phase are mainly used for bombardmnt because of their inert properties. 
Oxygen or nitrogen can be added to the plasme to deposit oxides or nitrides, respectively.
...
%Sputtering is of the latter kind, which is advantageous if substrates can't withstand high temperatures.
...
In other materials light moves with the velocity $v=c/n(\lambda)$, where $n(\lambda)$
...
%\td{it's adsorbed by certain groups?)} 
