...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Photovoltaics (PV) is one viable option for becoming carbon neutral. 
Furthermore, 
...
information on the general \td{functionsweise} of PV, the structure, characteristics and properties of materials which were used and computational, statistical and machine learning methods for data processing. 
