...
Finally, the results of alternative regression methods let loose on the data are compared with the \gls{emma} method. 
...
Altering the ratio of ingredients, adjusting pH (by adding \gls{naoh}, \gls{h2so4} or \gls{hcl}) or adding \gls{sds} as surfactant didn't increase the resistance of the resulting \gls{zro} layers. 
% ../../Data/SEM/SEM_2020_11_10_Old_Recipes/10_2L_19.tif
% ../../Data/SEM/SEM_2020_11_19_Old_Recipes/71_SL_NT4_11.tif
Even after the consecutive application of two layers, there was no improvement and the results examined with \gls{sem} reminded rather of a sparse crust than of a film. 
...
\td{Each line represents a I-V measurement at a distinct aluminium contact applied by sputtering through a mask. }
