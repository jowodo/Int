...
But fear not, that doesn't mean that computers are 
...
they can be divided into supervized (training set is labeled) and unsupervized (exploratory).  
...
There are also lesser know \gls{ml} algorithms like 
