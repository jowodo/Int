...
The sol-gel recipe reported by Hu et al.\cite{Hu2016} and further optimized, led to improved results (see section~\ref{sec:exp-sol-bu}). 
%
...
% These - I think - are rather only one layer deep irregularities since they are so prevalent and hardly any pinholes were electrically observed on similar samples. \todo{where is the evidence?}
...
The more coating layers, the more of the light is absorbed (at 600-\nm{1100}) by the \gls{zro} layers. 
...
Thicker coating layers reflect more light between approximately \nm{800} and \nm{1000}. 
...
%\todo{Following stirring times (in minutes) were tested and did not have an influence on stability of the solution: 10-10-20, 10-10-45, 30-30-180.}
...
%two layers were also tried but did not even pass the visual examination/test/inspection. 
