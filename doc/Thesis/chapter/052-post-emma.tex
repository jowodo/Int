...
%\textbf{Pre-writing:}
%\Gls{anova} does not provide a lot of extra information. 
...
Interestingly, the number of layers has the least amount of influence on the number probability of defects, which seems to be an artifact of the noise rather than a process property. 
