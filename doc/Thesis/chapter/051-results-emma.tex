...
%as one would expect more layers to be more insulating and thus result in lower conductivity and a lower probability of holes going all the way trough the \gls{zro} layers. %pin hole density. 
