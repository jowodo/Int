...
and was the same as for \gls{krr} plus \texttt{scale}. %$\gamma_{ml}$ 0.01, 0.05, 0.1, 0.5, 1, 5, 10, and \texttt{scale}. 
...
The score equals to the coefficient of determination $R^2$ which defined the following for non linear regression functions:
\begin{equation}
	\label{eq:r2}
