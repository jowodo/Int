...
\begin{figure}[htb]
	...
	(c) From the source clockwise: variable voltage source, built-in amperometer, gold plated tungsten probe, sputtered aluminium contact, \gls{zro} layer to be measured, steel substrate, dried silver paste contact, gold plated tungsten probe.}
\end{figure}
...
showed comparable passivization results and better stability of the solution. 
