...
reproducible. 
The \td{glass plate of the film applicator was therefore exchanged with a metal plate which}
...
\td{See} table \ref{tab:input} for the input space spanned during the optimization.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\iffalse
\begin{table}[ht!]
	\centering
