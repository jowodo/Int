...
Python and sci-kit learn \cite{pedregosa2011scikit} was used to implement a linear fit model, \gls{krr} and \gls{svm} with the kernels polynomial, \gls{rbf} and sigmoid. 
...
For each calculation the \td{5-fold} cross validation score was calculated. 
