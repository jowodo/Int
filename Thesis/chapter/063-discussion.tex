...
%\todo{british or US?: sation vs zation} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Narrowing, pre-optimisation and constraint phase}
\label{sec:phase2}
...
Finally, during the \gls{emma} optimisation the input data were not regularized, %es wurde auf regularisation verzichtet, 
