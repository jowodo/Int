...
Firstly, the \textit{research, exploration and design phase}, followed by the \textit{narrowing, pre-optimisation and constraint phase}, thereupon the \textit{optimisation, modelling and data generation phase} and finally the \textit{evaluation, interpretation and outlook phase}. 
...
A general experimental procedure was stated by Cherkassky and Mulier\cite{cerkassky1998learning}:
\begin{enumerate}
