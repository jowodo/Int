...
Section \ref{sec:results} is split into three subsections: material specific results are presented in section \ref{sec:res-mat}, results regarding \gls{pso} in \label{sec:res-emma} and further analysis in section \ref{sec:res-post}.
\td{Finally, section \ref{sec:outlook} discusses the outlook and next steps}
