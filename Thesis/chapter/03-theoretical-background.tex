...
%This chapter aims to shine light on the evolution of PV and on CIGSand 
...
These high energy particles start cascades of momentum transfers (see figure \td{cp sigmund 1969}). 
If a path of such a momentum transfer cascade reaches back to the surface and the kinetic energy of a surface 
...
middle of the 20th century and is now a field of research with its own niche subfields 
...
An argon plasma in a strong electrical field (some kV) provides the highly energetic particles. 
...
PVD can be divided into activation by thermal energy and activation by energetic particle bombardment. %\td{high-energy particles}.
%thermal and highly energetic particles activated. 
Sputtering is of the latter, which 
is advantageous if substrates can't withstand high temperatures.
%has the convenience, that some substrates can't withstand high temperatures. 
...
%sputtering are also a good adherent to the substrate and good step coverage and what else? 
...
%(the substrate represents the anode). 
...
%Through this method only conducting materials can be sputtered, be
\td{sputtered particles are neutral and not influenced by the electrical field}
%\td{different styles}\\
%The most successful/common/established type of sputtering devices are magnetron sputtering machines, which 
%Sputtering devices can be separated in DC (directional current) and RF (radio frequency) sputtering and reactive sputtering. 
%During RF sputtering, the voltage is wobbling which prevents charge accumulation on the target and thus also non conduction targets can be sputtered. 
