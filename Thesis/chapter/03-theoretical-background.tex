...
So ANOVA statistical significance result is independent of constant bias and scaling errors as well as the units used in expressing observations. %https://en.wikipedia.org/wiki/Analysis_of_variance#Summary_of_assumptions
