...
"The real purpose of experiment design is to maximize the information content of the data within the limits imposed by the given constraints."\cite{goodwin1977experiment}
Contstraints might include range constraints of input and output variables as well as total time available and total number of samples/experiments that can be taken.\cite{goodwin1977experiment}
...
In two cases a deliberate design of experiment makes sense. 
If the query of a new data point is very expensive it favourable to actively chose the query (e.g. drilling for oil or quantum chemical calculations). 
...
\url{https://www.jstor.org/stable/2238570}\cite{karlin1966optimal}
\url{https://rss.onlinelibrary.wiley.com/doi/abs/10.1111/j.2517-6161.1973.tb00944.x}\cite{whittle1973some}
