...
and potential use of \ch{CuInSe2} as \gls{pv} material in combination with \ch{CdS} was first mentioned in 1974\cite{wagner1974cuinse2}.
\td{Already in 1975 efficiencies of over 10\% were achieved.\cite{kazmerski1976thin}}
...
Why is there this \ch{CdS} layer? (n-material)
\gls{cigs} is p-material.
}
The glass substrate is located under the molybdenum electrode. 
It is the standard substrate because of it's high thermal stability, electrical resistance and mechanical hardness. 
