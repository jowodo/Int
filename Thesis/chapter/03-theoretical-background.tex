...
\textbf{A} will try to make to interrogator misjudge, whereas \textbf{B} is in the interrogators side.
The question is if \textbf{A} is replaced with an computer how the ratio of outcomes would deviate from the original ratio. 
%
%(in written form) and must judge who is the 
%if they are dealing with a machine or a human being. 
%
\td{It is easy for humans to come up with question to detect an AI, 
