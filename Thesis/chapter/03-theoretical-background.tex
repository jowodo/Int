...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wer penetration depth) of visible light than crystalline silicon (see table \ref{tab:cigs:alpha}). 
...
the creation of an electron hole pair and then its separation by the structure of the device.\cite{markvart2013principles}
