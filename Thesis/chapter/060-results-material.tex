...
\begin{figure}[htb]
    ...
    \end{subfigure}
    \caption{\td{UVVisIR}} \label{fig:ir}
\end{figure}
...
Figure \ref{fig:iv-log-good} shows \gls{iv} curves of an insulating sample, where ordinate shows the logarithm to the base of 10 of the absolute value of the current. 
...
\td{why cubic \gls{zro} when cubic stable above 2270C? todo: find xrd of monoclinic and tetragonal}
