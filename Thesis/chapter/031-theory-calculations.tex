...
It was originally inspired by the behaviour of bird flocks and fish schools\cite{Kennedy1995,villanova2010function}.
...
\td{statistical methods to bewerten a model are: cross validation, leave-one-out validation ( special case of cross validation), correlation coefficient for linear fits, mean square error. methods to fit data are: lin reg, polynomial regression, ridge regression, KRR, SVM and?} 
