...
The two independent variables $v_{cal}$ and $\lambda$ were included as \textit{optimisands} for two reasons: 
...
This idea has two flaws: there is only one set of \gls{bf}s for all \textit{optimisands} and thus 
