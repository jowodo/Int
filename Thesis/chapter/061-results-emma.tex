...
Indeed, the samples with the lowest \textit{optimisands} are amoung the first generation (see appendix \ref{sec:app-emma}, \td{and maybe fig gen-g}).
...
\begin{figure}[hb]
    ...
    \end{subfigure}
	\caption{$\gamma$ (a) and of $\rho$ (b) of each particle and each generation after initial selection process; \td{add caption for c and d. check if can plot with t=0}} 
    \label{fig:emma-gen}
\end{figure}
