...
\td{procedure into diffferen capitel: choose hyperparaters, choose dataset (emma). Grid search over hyperparameters and score with default scorer with default cross validation settings, k-fold=5? chose lowest score for each optimizand and algo (svm/krr) combo. Fit model with emma-data and chosen hyper parameters, predict different data sets and calculate statistics (MAE+MSE) for each data set.} 
