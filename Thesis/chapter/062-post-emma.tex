...
$C$, $\varepsilon$ and $\gamma_{ml}$, where $C$ took the values 0.05--1 with 0.05 steps, $\varepsilon$ 0.02--4 with 0.2 steps and $\gamma_{ml}$ 0.01, 0.05, 0.1, 0.5, 1, 5, 10, and \texttt{scale}. 
