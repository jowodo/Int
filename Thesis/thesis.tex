...
The current-voltage curves were measeured with Agilent 4156C Precision Semiconductor Parameter Analyzer after sputtering Aluminium contacts through a mask with \td{Sputtering Machine} assisted by \td{Leybold Univex 450 C} for the vacuum.
\begin{figure}
	\centering
