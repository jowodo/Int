...
The current-voltage curves were measured with Agilent 4156C Precision Semiconductor 
Parameter Analyzer after sputtering aluminium contacts through a mask with a Leybold 
...
\td{, creating a direct contact to steel subtrate by removing the \gls{zro} layer on the 
edge of the sample by scatching and applying silver paste.}
