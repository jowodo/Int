...
The average of each conductance would be obvious but difficult to represent a 
sample correctly since the possible values span accross several magnitudes.
So the average of logarithms of values is the next obvious ansatz.
