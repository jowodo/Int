...
had round patches of porous metal where underpressure to keep substrate in place (see 
figure~\ref{fig:eric}). After setting the heating plate temperature, the vacuum plate 
temperature (see figure \ref{fig:eric}) and the \gls{db} velocity, the \gls{db} blade 
...
This process was repeated as many times as needed.
\begin{figure}
	\centering
