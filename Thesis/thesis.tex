...
\label{sec:DB}
\todo{manual}
Before doctore blading with an automated machine manual \gls{DB} wire bar coaters was used. 
...
a the buthanolic recipe was introduced, which gave more homogeneous films.
