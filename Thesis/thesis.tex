...
Most
%All 
steel substrates (all pre-optimisation and optimisation samples) doctor bladed with an 
Erichsen Coatmaster 510 with a heatable plate.
...
%was used for doctor blading. The plate 
%An Erichsen Coatmaster 510 with a heatable plate was used for doctor blading. 
...
% which lead to very thin layers. 
...
With this new buthanolic recipe the limits of the optimization problem were explored in a 
preliminary study using the Plackett-Burman \cite{Plackett1946} design implemented in the 
\texttt{python3} library \texttt{pyDOE}.
